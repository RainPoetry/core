...
import com.guava.cc.oracle.monitor.Monitor;

import com.guava.cc.oracle.monitor.logminer.LogMiner;
import com.guava.cc.oracle.monitor.logminer.LogMinerConfig;
import com.guava.cc.oracle.monitor.logminer.LogMinerConfigException;
...
public class OracleMonitorManager extends Monitor {

	private static final int thread_nums = 5;
	private static final String offsetFile = "G:/oracle-ddl-offset";
