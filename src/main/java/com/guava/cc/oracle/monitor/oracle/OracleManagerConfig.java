...
import static com.rainpoetry.common.config.ConfigDef.Type.STRING;

public class OracleManagerConfig extends AbstractConfig {
	...
	public static String Target_DATABASE_DRIVER = "target.driver";

	// jdbc:oracle:thin:@localhost:1521:orcl
	public static String Target_DATABASE_URL = "target.url";

	// pccgz
	public static String Target_DATABASE_USERNAME = "target.username";

	// pccgz
	public static String Target_DATABASE_PASSWORD = "target.password";
	...
	static {
		CONFIG = new ConfigDef()
				...
				.define(Target_DATABASE_DRIVER, STRING, new NonEmptyString())
				.define(Target_DATABASE_URL, STRING, new NonEmptyString())
				.define(Target_DATABASE_USERNAME, STRING, new NonEmptyString())
				.define(Target_DATABASE_PASSWORD, STRING, new NonEmptyString())
	...
	public OracleManagerConfig(Map<?, ?> originals) {
