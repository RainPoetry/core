...
import rainpoetry.spark.rpc.common.{ThreadUtils, Utils}

import scala.concurrent.Future
import scala.concurrent.duration._
import scala.rainpoetry.common.config.ConfigTools
 ...
 */
private[rpc] class RpcTimeout(val duration: FiniteDuration, val timeoutProp: String)
...
private object RpcTimeout {
  ...
  def apply(conf: RpcConf, timeoutPropList: Seq[String], defaultValue: String): RpcTimeout = {
    ...
    val timeout = { ConfigTools.timeStringAs(finalProp._2,TimeUnit.SECONDS).seconds }
